...
This guide explains how to update your installation of the IntelligenceBank Postman Tool Generator MCP server when the underlying code is updated.
...
```bash
cd path/to/ib-postman-tool-generator
  ...
  "mcpServers": {
    "ib-postman-tool-generator": {
      ...
      "env": {
        ...
        "IB_API_ENVIRONMENT": "prod"  // New environment variable
      },
      "disabled": false,
      "alwaysAllow": [
